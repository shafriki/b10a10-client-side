...
const Register = () => {
  ...
  return (
    <div className="relative bg-cover bg-center min-h-screen"
      style={{ backgroundImage: "url('https://i.ibb.co.com/g9KKg0w/Untitled-design-20.png')"}}>
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-4 py-8 overflow-auto">
        ...
        <div className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg shadow-lg p-6 md:p-8 w-full sm:w-80 md:w-96">
          ...
          <form className="flex flex-col">
            ...
            <label htmlFor="email" className="text-green-500 text-sm mb-2"> Email
            </label>
            ...
            <p className="text-green-500 border-t mt-3 text-center text-sm font-medium"> OR REGISTER WITH</p>
