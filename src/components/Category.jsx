    ...
    <div className="bg-[#D9F7D0] text-white py-16 px-8 my-14 mx-3 max-w-screen-xl md:mx-auto shadow-xl">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
        ...
        <div>
          ...
          <h2 className="text-4xl text-[#1B3D2F] font-bold mb-4">Top Categories</h2>
        ...
        <div className="grid grid-cols-2 gap-4">
          {[
            ...
            <div key={index} className="flex flex-col items-center justify-center border border-white bg-white text-black rounded-lg py-6 text-center hover:bg-rose-100 transition-all">
